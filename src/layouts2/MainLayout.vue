  ...
  <q-layout view="lHh Lpr lFf">
    <q-header elevated>
      <q-toolbar>
        ...
        <q-toolbar-title class="my-box cursor-pointer q-hoverable" @click="this.$router.push(`/`)">
          Quasar App with GraphQL Engine
        </q-toolbar-title>
...
export default defineComponent({
  ...
  setup() {
    ...
    const authors = useResult(result, null, (data) => data.getAllUser);
